// ============================================================
// 👹 voidGoblin.js — Olivia's World: Crystal Keep
// ------------------------------------------------------------
// ✦ Full clone of goblin.js (zero functionality removed)
// ✦ Uses Void-themed sprites stored in sprites/voidGoblin/
// ✦ Supports frost slow, fire burn DoT, moon stun
// ✦ Full horde AI: path-follow, chase, return-to-path
// ✦ Death fade, HP bar, XP, gold, loot intact
// ✦ Works with wave system, spires, spells, ranged attacks
// ============================================================
/* ------------------------------------------------------------
 * MODULE: voidGoblin.js
 * PURPOSE:
 *   Implements the void goblin variant. Exact behaviour is
 *   cloned from goblin.js for 1:1 compatibility. Only sprite
 *   sources and 'type' strings differ.
 * ------------------------------------------------------------ */
...
function sidestepIfStuck(e, delta, dt) {
  ...
  if (e.holdingAtRange) return; // keep idle frame while holding attack range
...
async function loadGoblinSprites() {
  const sources = {
    idle: "./assets/images/sprites/voidGoblin/voidGoblin_idle.png",
    walkUp1: "./assets/images/sprites/voidGoblin/voidGoblin_W1.png",
    walkUp2: "./assets/images/sprites/voidGoblin/voidGoblin_W2.png",
    walkDown1: "./assets/images/sprites/voidGoblin/voidGoblin_S1.png",
    walkDown2: "./assets/images/sprites/voidGoblin/voidGoblin_S2.png",
    walkLeft1: "./assets/images/sprites/voidGoblin/voidGoblin_A1.png",
    walkLeft2: "./assets/images/sprites/voidGoblin/voidGoblin_A2.png",
    walkRight1: "./assets/images/sprites/voidGoblin/voidGoblin_D1.png",
    walkRight2: "./assets/images/sprites/voidGoblin/voidGoblin_D2.png",
    attackLeft1: "./assets/images/sprites/voidGoblin/voidGoblin_attack_left.png",
    attackLeft2: "./assets/images/sprites/voidGoblin/voidGoblin_melee_left.png",
    attackRight1: "./assets/images/sprites/voidGoblin/voidGoblin_attack_right.png",
    attackRight2: "./assets/images/sprites/voidGoblin/voidGoblin_melee_right.png",
    slain: "./assets/images/sprites/voidGoblin/voidGoblin_slain.png",
  };
...
export function updateGoblins(delta) {
  ...
  for (const e of goblins) {
    ...
    if (!player.invincible && distToPlayer > 0 && distToPlayer < 50) {
      const overlap = (50 - distToPlayer) * 0.6;
  ...
  // Cleanup dead goblins after fade
...
// ============================================================
// 🎯 DAMAGE — only enemyKilled type differs
// ============================================================
...
export function damageGoblin(goblin, amount) {
  ...
  if (goblin.hp <= 0) {
    ...
    Events.emit(E.enemyKilled, { type: "voidGoblin", x: goblin.x, y: goblin.y });
    Events.emit(E.waveKillRegistered, { type: "voidGoblin" });
