...
async function loadGoblinSprites() {
  goblinSprites = {
    idle: await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_idle.png"),
    walk: {
      up: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_W1.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_W2.png"),
      ],
      down: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_S1.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_S2.png"),
      ],
      left: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_A1.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_A2.png"),
      ],
      right: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_D1.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_D2.png"),
      ],
    },
    attack: {
      left: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_attack_left.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_melee_left.png"),
      ],
      right: [
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_attack_right.png"),
        await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_melee_right.png"),
      ],
    },
    slain: await loadImage("./assets/images/sprites/ashgoblin/ashGoblin_slain.png"),
  };
}
